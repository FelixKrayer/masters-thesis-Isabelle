...
\label{chapter:introduction}
  ...
  How about expressing lambda calculus terms? Let us consider lambda terms with paralell let bindings in the syntax $\mathtt{t} := \mathtt{x}\; |\; (\lambda x.\; t)\; |\; \mathtt{t}_1\; \mathtt{t}_2\; |\; \mathtt{let} x $ where $\mathtt{x}$ are variables.  
