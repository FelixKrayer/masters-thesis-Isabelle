  ...
  \section{Bounded Natural Functors (BNFs)}
    ...
    \subsection{BNF constants}
      ...
      \subsubsection{Bound and boundedness}
        ...
        The bound is used for the \textsc{set\_bd} axiom (formalized in \autoref{fig:bnf_axioms}) to ensure that the sets obtained by the setters are bounded. This ensures that the branching of a recursively defined datatype is also bounded and thus the resulting type $F$ as well.
